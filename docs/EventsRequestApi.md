# fds_api_gen_client.EventsRequestApi
...
with fds_api_gen_client.ApiClient(configuration) as api_client:
    ...
    api_instance = fds_api_gen_client.EventsRequestApi(api_client)
    orbital_events_request_dto = fds_api_gen_client.OrbitalEventsRequestDto() # OrbitalEventsRequestDto | 
...
with fds_api_gen_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = fds_api_gen_client.EventsRequestApi(api_client)
    sensor_event_request_dto = fds_api_gen_client.SensorEventRequestDto() # SensorEventRequestDto | 
...
with fds_api_gen_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = fds_api_gen_client.EventsRequestApi(api_client)
    station_visibility_events_request_dto = fds_api_gen_client.StationVisibilityEventsRequestDto() # StationVisibilityEventsRequestDto | 
