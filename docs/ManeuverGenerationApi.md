# fds_api_gen_client.ManeuverGenerationApi
...
with fds_api_gen_client.ApiClient(configuration) as api_client:
    ...
    api_instance = fds_api_gen_client.ManeuverGenerationApi(api_client)
    id = 'id_example' # str | 
...
with fds_api_gen_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = fds_api_gen_client.ManeuverGenerationApi(api_client)
    maneuver_generation_input_dto = fds_api_gen_client.ManeuverGenerationInputDto() # ManeuverGenerationInputDto | 
