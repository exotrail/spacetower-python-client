# fds_api_gen_client.MeasurementsRequestApi
...
with fds_api_gen_client.ApiClient(configuration) as api_client:
    ...
    api_instance = fds_api_gen_client.MeasurementsRequestApi(api_client)
    gps_pv_measurements_request_dto = fds_api_gen_client.GpsPvMeasurementsRequestDto() # GpsPvMeasurementsRequestDto | 
...
with fds_api_gen_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = fds_api_gen_client.MeasurementsRequestApi(api_client)
    gps_nmea_measurements_request_dto = fds_api_gen_client.GpsNmeaMeasurementsRequestDto() # GpsNmeaMeasurementsRequestDto | 
...
with fds_api_gen_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = fds_api_gen_client.MeasurementsRequestApi(api_client)
    optical_measurements_request_dto = fds_api_gen_client.OpticalMeasurementsRequestDto() # OpticalMeasurementsRequestDto | 
...
with fds_api_gen_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = fds_api_gen_client.MeasurementsRequestApi(api_client)
    radar_measurements_request_dto = fds_api_gen_client.RadarMeasurementsRequestDto() # RadarMeasurementsRequestDto | 
