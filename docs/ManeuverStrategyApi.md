# fds_api_gen_client.ManeuverStrategyApi
...
with fds_api_gen_client.ApiClient(configuration) as api_client:
    ...
    api_instance = fds_api_gen_client.ManeuverStrategyApi(api_client)
    maneuver_strategy_dto = fds_api_gen_client.ManeuverStrategyDto() # ManeuverStrategyDto | 
