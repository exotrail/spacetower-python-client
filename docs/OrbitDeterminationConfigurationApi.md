# fds_api_gen_client.OrbitDeterminationConfigurationApi
...
with fds_api_gen_client.ApiClient(configuration) as api_client:
    ...
    api_instance = fds_api_gen_client.OrbitDeterminationConfigurationApi(api_client)
    ukf_orbit_determination_configuration_dto = fds_api_gen_client.UkfOrbitDeterminationConfigurationDto() # UkfOrbitDeterminationConfigurationDto | 
