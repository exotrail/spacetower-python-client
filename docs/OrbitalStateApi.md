# fds_api_gen_client.OrbitalStateApi
...
with fds_api_gen_client.ApiClient(configuration) as api_client:
    ...
    api_instance = fds_api_gen_client.OrbitalStateApi(api_client)
    orbital_state_creation_request_dto = fds_api_gen_client.OrbitalStateCreationRequestDto() # OrbitalStateCreationRequestDto | 
